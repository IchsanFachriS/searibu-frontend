 ...
 * 
 * Akses: Pro subscription saja.
 * Role tetap ada di profil tapi tidak mempengaruhi fitur ini.
 */
...
const LABELS = {
  en: {
    ...
    needsProHint:  "S-104 HDF5 export is available on the Pro plan",
  ...
  id: {
    ...
    needsProHint:  "Ekspor S-104 HDF5 tersedia di paket Pro",
...
export const S104ExportSection: React.FC<Props> = ({ coordinates, selectedDate, language: lang }) => {
  ...
  // S-104 hanya butuh Pro — tidak cek role
  ...
  return (
    <>
      <div style={{ marginTop: 7, position: "relative" }}>
        ...
        {/* Buttons */}
        <div style={{ display: "flex", flexDirection: "column", gap: 5, opacity: hasAccess ? 1 : 0.18, pointerEvents: hasAccess ? "auto" : "none" }}>
