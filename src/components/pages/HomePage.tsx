...
const COPY = {
  en: {
    ...
    problemHead:    "Sea conditions determine whether a trip is safe.",
    ...
    stdBody:    "The system architecture follows IHO S-100 Universal Hydrographic Data Model and IHO S-104 Water Level Information for Surface Navigation, ensuring long-term interoperability with electronic navigational chart environments.",
  ...
  id: {
    ...
    problemHead:    "Kondisi laut menentukan keselamatan perjalanan.",
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", position: "relative", zIndex: 2 }} ref={std.ref}>
          <div className="std-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16, ...secAnim(std.inView, 150) }}>
              {[
                { code: "IHO S-100", color: PRIMARY_SOFT, desc: language === "id" ? "Universal Hydrographic Data Model — kerangka induk seluruh produk data maritim digital." : "Universal Hydrographic Data Model — the overarching framework for all digital maritime data products." },
                { code: "IHO S-104", color: PRIMARY_SOFT, desc: language === "id" ? "Water Level Information for Surface Navigation — spesifikasi produk untuk data muka air, diadopsi Desember 2024." : "Water Level Information for Surface Navigation — product specification for water level data, adopted December 2024." },
                { code: "TPXO9-Atlas", color: TEAL, desc: language === "id" ? "Model pasut global: 15 konstituen harmonik, resolusi 1/30°. Analisis harmonik mengikuti Schureman (1958) & Foreman (1977)." : "Global tidal model: 15 harmonic constituents, 1/30° resolution. Harmonic analysis per Schureman (1958) & Foreman (1977)." },
              ].map((s, i) => (
                <div key={i} style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(14,165,233,0.10)", borderRadius: 6, padding: "18px 22px", display: "flex", gap: 18, alignItems: "flex-start" }}>
                  ...
                  <div>
                    <div style={{ display: "flex", alignItems: "baseline", gap: 10, marginBottom: 6 }}>
                      ...
                      <span style={{ fontFamily: SANS, fontSize: 10, color: "rgba(255,255,255,0.35)", letterSpacing: "0.05em", textTransform: "uppercase" as const }}></span>
                    </div>
