...
const COPY = {
  en: {
    ...
    features: [
      ...
      { num: "03", title: "Interactive WebGIS Atlas",  body: "Leaflet map with TPXO-9 Atlas spatial grids, island markers, and the water level observation station.", icon: "map" },
      { num: "04", title: "Activity Safety Ratings",   body: "Science-based thresholds for 11 marine activities.", icon: "shield" },
      { num: "05", title: "Observation vs. Prediction",body: "Real-time water levels observation overlaid on TPXO. Transfer of Level correction −2.156 m for MSL.", icon: "chart" },
  ...
  id: {
    ...
    features: [
      ...
      { num: "03", title: "WebGIS Interaktif",             body: "Peta Leaflet dengan grid TPXO, penanda pulau, dan stasiun observasi pasang surut. Klik sel grid untuk data lokal.", icon: "map" },
      { num: "04", title: "Penilaian Keamanan Aktivitas",  body: "Ambang batas ilmiah untuk 11 aktivitas wisata bahari.", icon: "shield" },
      { num: "05", title: "Observasi vs. Prediksi",        body: "Muka air real-time dioverlay di atas prediksi TPXO. Koreksi TOL −2,156 m untuk MSL.", icon: "chart" },
