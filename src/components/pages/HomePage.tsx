...
const COPY = {
  en: {
    ...
    features: [
      { num: "01", title: "TPXO Tidal Prediction",    body: "Hourly astronomical tides from TPXO9 Atlas using 15 harmonic constituents.", icon: "waves" },
      { num: "02", title: "Real-time Marine Forecast", body: "Wind, wave height, and current velocity updated hourly", icon: "wind" },
      { num: "03", title: "Interactive WebGIS Atlas",  body: "Leaflet map with spatial grids and island markers", icon: "map" },
      { num: "04", title: "Activity Safety Ratings",   body: "Science-based thresholds for 11 marine activities.", icon: "shield" },
      { num: "05", title: "Observation vs. Prediction",body: "Real-time water levels observation from the tidal station.", icon: "chart" },
  ...
  id: {
    ...
    features: [
      { num: "01", title: "Prediksi Pasut TPXO",          body: "Prediksi pasut astronomis per jam dari TPXO-9 Atlas menggunakan 15 konstituen harmonik", icon: "waves" },
      { num: "02", title: "Prakiraan Laut Real-time",      body: "Angin, tinggi gelombang, dan kecepatan arus diperbarui per jam", icon: "wind" },
      { num: "03", title: "WebGIS Interaktif",             body: "Peta dengan grid spasial dan penanda pulau", icon: "map" },
      { num: "04", title: "Penilaian Keamanan Aktivitas",  body: "Ambang batas ilmiah untuk 11 aktivitas wisata bahari.", icon: "shield" },
      { num: "05", title: "Observasi vs. Prediksi",        body: "Muka air real-time dari stasiun observasi", icon: "chart" },
